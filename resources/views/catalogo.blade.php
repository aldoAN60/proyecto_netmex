                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="background: #038c5a; font: condensed 120% sans-serif; font-size: 15pt; color: #FFFFFF;">
                            ...
                            <div class="container" style="width:60%; float: left;">
                                ...
                                @switch($topSemanal['id'])
                                    @case(594767)
                                        <source src="/videos/shazam.mp4" type='video/mp4'>
                                        @break
                                    @case(76600)
                                        <source src="/videos/avatar.mp4" type='video/mp4'>
                                        @break
                                    @case(603692)
                                        <source src="/videos/jw4.mp4" type='video/mp4'>
                                        @break
                                    @case(502356)
                                        <source src="/videos/smb.mp4" type='video/mp4'>
                                        @break
                                    @case(677179)
                                    ...
                                    @case(640146)
                                        ...
                                        @break
                                    @case(315162)
                                        <source src="/videos/pib2.mp4" type='video/mp4'>
                                        @break
                                    @default
                                        <source src="/videos/conoce2motolika.mp4" type='video/mp4'>
                                @endswitch
                                @if($topSemanal['id'] == "315162")  @else <source src="/videos/conoce2motolika.mp4"s     type='video/mp4'> @endif
