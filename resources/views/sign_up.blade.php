        ...
        <div class="col">
            <div class="sign-up">
                <form>
                    ...
                    <div class="mb-4">
                        <input type="email" class="form-control" id="frm-email" placeholder="Email" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-4">
                        <input type="password" class="form-control" id="frm-password" placeholder="contraseña" required>
                    </div>
